...
#Preview {
    ...
    let treatmentNotifier = TreatmentNotifications() // Create notifier for preview
    ...
    return NavigationStack { // Wrap preview in NavigationStack if ManageTreatmentsView is typically used within one
        ManageTreatmentsView()
            ...
            .environment(treatmentNotifier) // Inject notifier into ManageTreatmentsView itself
    }
}
#endif
